...
- placeNotes should only be included when a selected constraint creates a meaningful suitability concern for that place.
- restaurantAdvice should only mention restaurants actually present in the supplied catalog.
